<template>
  <div class="bg-[#2A3742] h-[calc(100vh-72px)] overflow-auto">
    ...
    <div class=" mt-2">
        ...
        <div class="grid grid-cols-3 max-w-[450px] gap-4 ">
    <div class="flex flex-col">
        <div class=" bg-[#E8E8E8] p-4 flex justify-center items-center rounded-lg border-2 border-[#A549E0] cursor-pointer flex-grow">
            <div class="w-[70px] h-[70px] bg-white rounded-lg"></div>
        </div>
        <p class="text-white mt-2">1080x1080px</p>
    </div>
    <div class="flex flex-col">
        <div class=" bg-[#E8E8E8] p-4 flex justify-center items-center rounded-lg cursor-pointer flex-grow">
            <div class="w-[100px] h-[50px] bg-white rounded-lg"></div>
        </div>
        <p class="text-white mt-2">1200x628px</p>
    </div>
    <div class="flex flex-col">
        <div class=" bg-[#E8E8E8] p-4 flex justify-center items-center rounded-lg cursor-pointer flex-grow">
            <div class="w-[60px] h-[60px] bg-white rounded-lg"></div>
        </div>
        <p class="text-white mt-2">500x500px</p>
    </div>
</div>

    </div>
     <div class="mt-10  ">
        <img  class="rounded-lg"  src="../static/hero-image.png " alt="">
